...
| **Week 3** | **17/08/26 – 22/08/26** | • Developed and evaluated weighted and unweighted XGBoost training pipelines<br>• Used 5-fold validation for model evaluation<br>• Achieved an overall **F1-score of 0.67** and **Correct-class F1-score of 0.80**<br>• Continued expert annotation for Supine Heel Slides and Shoulder Flexion<br>• Gathered patient height data<br>• Evaluated Arduino Uno Q for deployment<br>• Researched depth-camera-compatible exercises and collected additional patient data | • Further improve model performance<br>• Continue height data collection and dataset refinement<br>• Shortlist exercises involving movement in the Z-plane<br>• Continue data collection for Supine Heel Slides and Shoulder Flexion | • Arduino Uno Q was unsuitable for the project as OpenCV could not be installed<br>• Model performance still requires improvement, particularly for error detection | **[View Commit](https://github.com/PaayalKapoor/BE_Project_2026_2027/commit/9726e3a85fcff68a963f547b1df825740a44c94f)** |
| **Week 4** | **24/08/26 – 29/08/26** | • Shortlisted **Bicep Curls and Squats** for depth-camera data collection and finalized filming setup<br>• Updated Supine Heel Slides pipeline with **pixels-per-cm normalization** using patient height<br>• Regenerated and cleaned the dataset; **259 repetitions** retained<br>• Trained and evaluated **Random Forest and XGBoost** models on the updated dataset<br>• Continued patient data collection for Supine Heel Slides and Shoulder Flexion | • Further improve Supine Heel Slides model performance<br>• Analyse and address speed-error classification performance<br>• Continue data collection and validation<br>• Begin recording Bicep Curls and Squats using the depth camera | • Slanted camera angles caused landmark jitter, requiring affected videos to be discarded<br>• Contradictory rows still present in the regenerated dataset<br>• Speed-error classification performance remains comparatively low | **[View Commit](https://github.com/PaayalKapoor/BE_Project_2026_2027/commit/c69cc53f2348132a6e643528be2e400211f706fd)** |
| **Week 5** | **31/08/26 – 05/09/26** | • Expanded dataset to **392 repetitions** and continued model training<br>• Tested RF, XGBoost, AdaBoost and Logistic Regression<br>• Explored binary classification for heel-lift and velocity errors<br>• Logistic Regression showed more meaningful feature weighting compared to tree-based models<br>• Set up depth camera pipeline for Bicep Curls using raw `.db3` data<br>• Studied Raspberry Pi for possible deployment<br>• Continued patient data collection and explored hospital collaboration<br>• Reviewed research paper requirements and identified changes needed in the Phase 1 rule-based system | • Further optimize the ML models and feature set<br>• Continue data collection and annotation<br>• Develop dataset for Bicep Curls and Squats<br>• Implement required changes to the Phase 1 system for research validation | • Severe class imbalance, particularly for velocity-error samples<br>• Tree-based models assigned high importance to less relevant features<br>• Velocity-error detection remains challenging<br>• Need certified expert annotations for final system accuracy evaluation | **[Model Updates](https://github.com/PaayalKapoor/BE_Project_2026_2027/commit/1e875cfc3318388ecd8950f620ad7c4bbd8833bc) [Depth Camera Integration](https://github.com/PaayalKapoor/BE_Project_2026_2027/commit/c96dcb5d4bb9330318be1364a99f6daff71f5ad7)** |
| **Week 6** | **08/09/26 – 11/09/26** | • Continued annotation of Shoulder Flexion data and generated Dataset – Approach 2<br>• Modified Phase 1 rule-based system and dataset pipeline for Squats<br>• Explored neural-network approaches for time-series classification<br>• Evaluated SVM and Logistic Regression; limited by small and imbalanced dataset<br>• Trained an LSTM model for heel-lift and velocity-error detection<br>• Continued discussions with Sushrut Hospital for data collection | • Collect additional clinical data<br>• Continue LSTM and time-series model evaluation<br>• Improve Phase 1 validation pipeline and cross-verify outputs with certified expert annotations<br>• Resume hyperparameter tuning once sufficient data is available | • Limited and highly imbalanced dataset causing unstable evaluation metrics<br>• SVM performance was lower than previous tree-based models<br>• Hyperparameter tuning deferred until more data is collected | **[SVM Model](https://github.com/PaayalKapoor/BE_Project_2026_2027/commit/4e1dd52023bba2f3c7841772e8d2de250b9015e7)<br>[LSTM Model](https://github.com/PaayalKapoor/BE_Project_2026_2027/commit/a7299c86008c41aef77a97515f72f2a6b9499138)** |
| **Week 7** | **15/09/26 – 19/09/26** | • Started development of **live feature extraction** for Supine Heel Slides<br>• Started testing **Kalman filtering** to avoid the delay caused by Savitzky–Golay filtering<br>• Recorded additional Supine Heel Slide videos from family & friends<br>• Added a **velocity feature** to improve velocity-error classification and regenerated the dataset<br>• Trained and evaluated **Logistic Regression, SVM, RF, XGBoost and AdaBoost** models<br>• Improved Shoulder Flexion feature extraction with interpolation and other important features | • Continue development of live feature extraction<br>• Evaluate Kalman filter for real-time processing<br>• Continue improving model performance using the new velocity feature<br>• Continue Shoulder Flexion dataset generation and model development | • Real-time processing requires a causal filter without future samples<br>• Velocity-error classification remains challenging due to limited positive samples<br>• Shoulder Flexion feature extraction required modifications and debugging | **[Shoulder Flexion Feature Extraction](https://github.com/PaayalKapoor/BE_Project_2026_2027/commit/47784a83f81013885e9b6733035214f22aeafe7d)<br>[Dataset Generated](https://github.com/PaayalKapoor/BE_Project_2026_2027/commit/3f9c9480b108ddec1ab2a3cbc3a5f4622ea147fb)** |
| **Week 8** | **21/09/26 – 26/09/26** | • Received permission for data collection from Sushrut Hospital<br>• Continued annotation for shoulder flexion execise through an online meet with a physiotherapist<br>• Continued data collection in clinics<br>•Interfaced web canera with Jetson Nano | • Finish development of live feature extraction<br>• Try training sequential (temporal) dataset with Encoder based models and Attention LSTM<br>• Continue Shoulder Flexion dataset generation and model development | • The sequential model learns the whole temporal pattern. But heel lift is present only in a part of the sequence and the start of that sequence is not deterinistic. This leads to lower precision for heel lift class. Correct reps are being classified as heel lift error since the model has learnt an incorrect pattern for heel lift. Thus, try training this data using Attention based LSTM which would focus on the important part of the sequence | **[Livestream Supine Heel Slides Feature Extraction & Supine Heel Slides (Temporal) Dataset Generated](https://github.com/PaayalKapoor/BE_Project_2026_2027/commit/e4e389333b0cd30a4db24cb3ef75352005490c4e)** |
---
